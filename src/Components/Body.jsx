...
const Body = () => {
    ...
    async function fetchData() {
        let data = await fetch("https://cors-anywhere.herokuapp.com/http://www.swiggy.com/dapi/restaurants/list/v5?lat=30.7083792&lng=76.7718838&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING");
